...
public class CajeroProdubanco implements CajeroInterfaz {
	...
	public void solicitarMonto(int monto) {
		// TODO Auto-generated method stub
		System.out.println("1.Selecciones la cantidad a retirar");
		System.out.println("2.Consultar saldo disponible");
	...
	public void validarElSaldo() {
		...
		System.out.println("Si desea imprimir digite si");
		System.out.println("Imprimir consulta con sobre cargo de 0,25");
		System.out.println("------------------------------------------");
	...
	public void entregarRecibo() {
		...
		System.out.println("Gracias por su preferencia a Produbanco.");
	}
