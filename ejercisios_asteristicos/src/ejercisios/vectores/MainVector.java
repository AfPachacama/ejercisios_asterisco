package ejercisios.vectores;

public class MainVector {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		//1. Declarar un vector miVector.
		
		int miVector[] = new int[10];
		//2 .Declarar un vector miVector[] tipo char.
		...
		miVec1[1] = 0;
		miVec1[2] = 0;
		//miVec1[3] = 0;Es una mala asignacion porque esta fuera de rango la posicion 3.
		
		
		//5. Declarar un vector miVec2[3] de tipo char y asignamos la letra A a las posiciones 0 y 1; y la posicion 2 la letra B
