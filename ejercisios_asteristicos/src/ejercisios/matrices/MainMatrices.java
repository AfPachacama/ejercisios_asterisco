...
public class MainMatrices {
	...
	public static void main(String[] args) {
		...
		//3. Declara una matriz miMatriz de long con 2 filas y 4 columnas.
		long miMatriz[][]= new long[2][4];
		
		//4. Declara una matriz miMatriz1 de long con 1 fila y 2 columnas.
		// y asignar a la posicion[0][0], el valor de 8, posicion[1][1] el valor de 8
